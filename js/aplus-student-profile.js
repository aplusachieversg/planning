...
(function(){
  ...
  function inject(){
    ...
    ["spTargetField","spTargetUniversity","spEntryYear"].forEach(function(id){const el=document.getElementById(id);if(el)el.addEventListener("change",targetSync);}); targetSync();
