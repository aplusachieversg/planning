...
(function(){
  ...
  function updateAcademicAnalysis(){
    ...
    const domainRows=(a.domainProfile?.domains||[]).map(x=>'<div style="display:flex;justify-content:space-between;gap:12px;margin-top:5px"><span>'+esc(x.label)+'</span><b>'+esc(x.strength)+'</b></div>').join("");
