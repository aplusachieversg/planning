...
(function(){
  ...
  function renderUI(){
    ...
    panel.innerHTML=
      ...
      '<div><label>Organisation / Institution</label><input id="expOrg" '+inputStyle()+' placeholder="Organisation or institution"></div><div><label>Organisation Level</label><div style="font-size:10px;color:#98a2b3;margin:-4px 0 6px">Where the organisation / programme sits.</div>'+select("expOrgLevel",TAXONOMY.organisationLevels,"Select level")+'</div>'+
      ...
      '<div><label>Role</label>'+select("expRole",TAXONOMY.roles,"Select role")+'</div><div><label>Participation Level</label><div style="font-size:10px;color:#98a2b3;margin:-4px 0 6px">The scale at which you participated.</div>'+select("expParticipation",TAXONOMY.participationLevels,"Select level")+'</div>'+
      '<div><label>Achievement Level</label><div style="font-size:10px;color:#98a2b3;margin:-4px 0 6px">What you personally achieved.</div>'+select("expAchievement",TAXONOMY.achievementLevels,"Select achievement")+'</div><div><label>Evidence</label>'+select("expEvidence",TAXONOMY.evidenceTypes,"Select evidence")+'</div>'+
